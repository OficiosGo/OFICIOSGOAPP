...
async function main() {
  ...
  const pro = {
    ...
    bio: "Mas de 12 años trabajando en instalaciones electricas domiciliarias e industriales en Villa María y Villa Nueva y zona. Matriculado ante el Colegio de Tecnicos. Trabajo con garantia escrita.",
